...
<div class="lr10 CMS_message" id="roll">
    ...
    <li>已购买授权用户，请加群交流运营经验：58453439【加群须备注授权域名】</li>
</div>
<div class="bk10"></div>
...
<!------------>
    ...
    <div class="div-about width30">
        ...
        <div class="bk10"></div>
        <ul>
        	<li><i>程序版本:</i><?php echo $versions['version']; ?><font color="#f60">【企业版】</font></li>
			<li><i>更新时间:</i><?php echo $versions['release']; ?></li>
             <li><i>程序开发:</i>重庆韬龙网络科技有限公司</li>
            <li><i>版权所有:</i>重庆韬龙网络科技有限公司</li>     
            <li><i>官方微博:</i><a href="http://weibo.com/koomao" target="_black" style="color:#0f0">关注官方微博</a></li>        
        </ul>
